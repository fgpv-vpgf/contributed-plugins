...
NOTE: To have the slider initialize the values from the layers, layer must be ESRI type with dual range type and dynamic limit. Whit the other type of range and limit, it is better to define the limit with a multiple that can
