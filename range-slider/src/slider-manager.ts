                ...
                response.text().then(text => {
                    ...
                    if (typeof timeInfo !== 'undefined') {
                        ...
                        const intervals = {
                            ...
                            esriTimeUnitsYears: 31561920000 // 31536000000 = year ... need to add .25 plus handle 1 every 4 years
                        }
    ...
    processWMSExtent(extent: any): object {
        ...
        if (this.isDiscreteExtent(extent)) {
            ...
            if (typeof isoInterval === 'undefined') {
                ...
                // in this case, the static item array is only use to detmine the static interval step
