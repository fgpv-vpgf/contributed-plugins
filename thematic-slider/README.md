# Thematic Slider
This plugin let you add a thematic slider to your map. It loop trought an array of layers to show comparaison or evolution of geolocation data. At the same time, the plugin can you show a title and description for each of the layers.
...
- autorun: boolean to start the animation atomatically (if true, open should be true as well)
